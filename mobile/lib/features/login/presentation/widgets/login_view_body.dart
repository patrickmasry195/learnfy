              ...
              child: Column(
                children: [
                  ...
                  CustomButton(
                    ...
                    buttonNameFontColor: Colors.white,
                    buttonNameFontSize: 18,
                    height: 57,
                  ...
                  CustomDivider(
                    inBetweenText: "OR",
                    inBetweenTextStyle: TextStyle(fontSize: 16),
                    leftDividerThickness: 1,
                    rightDividerThickness: 1,
                    dividerColor: Colors.grey.shade300,
                    leftSideDividerPadding: 10,
                    rightSideDividerPadding: 10,
                  ),
                  SizedBox(height: 16),
                  AuthWithPlatforms(
                    iconUrl:
